...
Examples:
- `/design-audit docs/plan-github-oauth.md`
- `/design-audit docs/plan-session-sharing.md`
...
Check that the file path exists and is a markdown file. If no path is given, look for the most recently modified `docs/plan-*.md` file.

---

## Step 2 — Initialize audit log

Derive the log filename from the design doc: `docs/plan-github-oauth.md` → `.agent/audits/design-github-oauth-<YYYY-MM-DD>.md`.
