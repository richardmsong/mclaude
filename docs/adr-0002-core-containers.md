...
Deploy using the deployment plan (`docs/adr-0003-k8s-integration.md`) and run its verification section (17 steps covering project lifecycle, session lifecycle, memory sharing, config sync, resilience, and provisioning).
...
mclaude/
  ...
  docker-compose.yml
  docs/
    adr-0003-k8s-integration.md   (deployment plan — cluster-specific)
    adr-0002-core-containers.md   (this file — core software)
```
