...
1. **Read specs** — `docs/feature-list.md` (features + support matrix) and `docs/adr-0006-client-architecture.md` (architecture, protocol, accumulation logic, cache handling)
